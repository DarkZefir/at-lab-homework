...
class LoginPage {
    ...
    async agreeStepFive() {
        await this.pushCashOnDelivery.waitForClickable(4000);
        await this.pushCashOnDelivery.click()
        await this.agreeCheckbox.waitForClickable(4000);
    ...
    async textInStepFour() {
        ...
        await this.continueStepFourButton.waitForClickable(4000)
        await this.continueStepFourButton.click();
    }

    async selectRegion() {
        await this.openDropdownRegion.click();
        await this.openDropdownRegion.waitForClickable(4000);
    ...
    async selectCountry() {
        ...
        await this.openDropdownCountry.waitForClickable(4000);
    ...
    async choosePlaceholderStepTwo(text, text2) {
        ...
        await dropdownOption.waitForClickable(4000);
